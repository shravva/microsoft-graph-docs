...
[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]
 [!CAUTION] The getResourcesFolderUrl API is deprecated and will stop returning data on May 31, 2021. Please use the new property `resourcesFolderUrl` exposed on [educationAssignment](../resources/educationassignment.md) entity to fetch the same info. 
